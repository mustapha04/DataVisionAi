...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:5173", "http://localhost:3000", "https://datavisionai.vercel.app", "https://data-vision-ai-pied.vercel.app", "https://datavisionai-jqka.onrender.com"],
